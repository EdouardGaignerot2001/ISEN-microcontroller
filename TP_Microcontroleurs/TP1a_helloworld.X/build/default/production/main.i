...
void main(void) {
    ...
    output_D(0x01 | 0x02 | 0x04 | 0x08);
    output_B(0x01 | 0x02 | 0x04 | 0x08);

    while(1){
        enable_D(0x01 | 0x02 | 0x04 | 0x08);
        disable_B(0x01 | 0x02 | 0x04 | 0x08);
        _delay((unsigned long)((500)*(8000000/4000.0)));
        disable_D(0x01 | 0x02 | 0x04 | 0x08);
        enable_B(0x01 | 0x02 | 0x04 | 0x08);
        _delay((unsigned long)((500)*(8000000/4000.0)));
    }
}
